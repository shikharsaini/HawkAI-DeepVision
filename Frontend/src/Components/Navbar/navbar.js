...
function Navbar(){
    ...
    <nav className="navbar sticky-top navbar-expand-lg bg-light Navbox">
        <div className="container-fluid">
            <a className="navbar-brand heading" href="http://localhost:3000/">HawkAI DeepVision  <img src="https://img.icons8.com/external-others-iconmarket/100/000000/external-eagle-unites-state-of-america-others-iconmarket-2.png"/></a>
